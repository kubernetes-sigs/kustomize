// Code generated by pluginator on KindOrderTransformer; DO NOT EDIT.
package builtin
...
type KindOrderTransformerPlugin struct {
...
func (p *KindOrderTransformerPlugin) Config(
...
func (p *KindOrderTransformerPlugin) GetOrderFirst() []string {
...
// Returns the list of kind to order first.
func (p *KindOrderTransformerPlugin) GetOrderLast() []string {
...
func (p *KindOrderTransformerPlugin) Transform(m resmap.ResMap) (err error) {
...
func NewKindOrderTransformerPlugin() resmap.TransformerPlugin {
	return &KindOrderTransformerPlugin{}
}
