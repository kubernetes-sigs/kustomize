// Code generated by pluginator on KindFilterTransformer; DO NOT EDIT.
package builtin
...
type KindFilterTransformerPlugin struct {
...
func (p *KindFilterTransformerPlugin) Config(
...
func (p *KindFilterTransformerPlugin) Transform(m resmap.ResMap) error {
	ids := m.AllIds()
...
func NewKindFilterTransformerPlugin() resmap.TransformerPlugin {
	return &KindFilterTransformerPlugin{}
}
