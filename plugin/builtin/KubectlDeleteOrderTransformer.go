// Code generated by pluginator on KubectlDeleteOrderTransformer; DO NOT EDIT.
package builtin
...
type KubectlDeleteOrderTransformerPlugin struct {
	KindOrder []string `json:"kindorder,omitempty" yaml:"kindorder,omitempty"`
}

//noinspection GoUnusedGlobalVariable
func NewKubectlDeleteOrderTransformerPlugin() *KubectlDeleteOrderTransformerPlugin {
	return &KubectlDeleteOrderTransformerPlugin{}
}

// Nothing needed for configuration.
func (p *KubectlDeleteOrderTransformerPlugin) Config(
...
//
func (p *KubectlDeleteOrderTransformerPlugin) GetSortOrder() []string {
...
func (p *KubectlDeleteOrderTransformerPlugin) Transform(m resmap.ResMap) (err error) {
