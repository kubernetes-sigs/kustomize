// Code generated by pluginator on KubectlApplyOrderTransformer; DO NOT EDIT.
package builtin
...
type KubectlApplyOrderTransformerPlugin struct {
	KindOrder []string `json:"kindorder,omitempty" yaml:"kindorder,omitempty"`
}

//noinspection GoUnusedGlobalVariable
func NewKubectlApplyOrderTransformerPlugin() *KubectlApplyOrderTransformerPlugin {
	return &KubectlApplyOrderTransformerPlugin{}
}

// Nothing needed for configuration.
func (p *KubectlApplyOrderTransformerPlugin) Config(
...
//
func (p *KubectlApplyOrderTransformerPlugin) GetSortOrder() []string {
...
func (p *KubectlApplyOrderTransformerPlugin) Transform(m resmap.ResMap) (err error) {
