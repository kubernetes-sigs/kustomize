...
func _() {
	...
	_ = x[KindOrderTransformer-15]
	_ = x[KindFilterTransformer-16]
}

const _BuiltinPluginType_name = ""

var _BuiltinPluginType_index = [...]uint16{0, 7, 22, 40, 63, 83, 107, 137, 153, 169, 191, 214, 233, 248, 268, 290, 310, 331}
