...
// Package decoder contains YAML or JSON decoder types and methods
// This file is copied from k8s.io/apimachinery/pkg/util/yaml/decoder.go
package decoder
...
// JSONSyntaxError for JSON syntax
...
// YAMLSyntaxError for YAML syntax
...
// YAMLReader implement the Reader interface
type YAMLReader struct {
	reader Reader
}

// NewYAMLReader returns a YAMLReader object
...
// LineReader to read single line
