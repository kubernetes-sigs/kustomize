...
var precomputedIsNamespaceScoped = map[yaml.TypeMeta]bool{
	{APIVersion: "acme.cert-manager.io/v1", Kind: "Challenge"}:                                true,
	{APIVersion: "acme.cert-manager.io/v1", Kind: "Order"}:                                    true,
	...
	{APIVersion: "cert-manager.io/v1", Kind: "CertificateRequest"}:                            true,
	{APIVersion: "cert-manager.io/v1", Kind: "ClusterIssuer"}:                                 false,
	{APIVersion: "cert-manager.io/v1", Kind: "Issuer"}:                                        true,
	...
	{APIVersion: "moco.cybozu.com/v1beta2", Kind: "BackupPolicy"}:                             true,
	{APIVersion: "moco.cybozu.com/v1beta2", Kind: "MySQLCluster"}:                             true,
