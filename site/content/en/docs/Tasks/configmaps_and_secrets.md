...
ConfigMap and Secret objects can be generated by adding a `configMapGenerator` and `secretGenerator` entry to the `kustomization.yaml` file.
...
## Propagate Configap Name Suffix
