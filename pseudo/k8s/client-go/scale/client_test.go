...
import (
	...
	fakedisco "sigs.k8s.io/kustomize/pseudo/k8s/client-go/discovery/fake"
	"sigs.k8s.io/kustomize/pseudo/k8s/client-go/dynamic"
	fakerest "sigs.k8s.io/kustomize/pseudo/k8s/client-go/rest/fake"
	...
	extv1beta1 "sigs.k8s.io/kustomize/pseudo/k8s/api/extensions/v1beta1"
	"sigs.k8s.io/kustomize/pseudo/k8s/client-go/restmapper"
	coretesting "sigs.k8s.io/kustomize/pseudo/k8s/client-go/testing"
)
