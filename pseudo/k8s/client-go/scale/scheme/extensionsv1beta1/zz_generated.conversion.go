...
func autoConvert_v1beta1_ScaleStatus_To_scheme_ScaleStatus(in *v1beta1.ScaleStatus, out *scheme.ScaleStatus, s conversion.Scope) error {
	out.Replicas = in.Replicas
	// WARNING: in.Selector requires manual conversion: inconvertible types (map[string]string vs *sigs.k8s.io/kustomize/pseudo/k8s/apimachinery/pkg/apis/meta/v1.LabelSelector)
...
func autoConvert_scheme_ScaleStatus_To_v1beta1_ScaleStatus(in *scheme.ScaleStatus, out *v1beta1.ScaleStatus, s conversion.Scope) error {
	out.Replicas = in.Replicas
	// WARNING: in.Selector requires manual conversion: inconvertible types (*sigs.k8s.io/kustomize/pseudo/k8s/apimachinery/pkg/apis/meta/v1.LabelSelector vs map[string]string)
	return nil
}
