...
import (
	...
	"sigs.k8s.io/kustomize/pseudo/k8s/client-go/informers"
	"sigs.k8s.io/kustomize/pseudo/k8s/client-go/metadata"
	"sigs.k8s.io/kustomize/pseudo/k8s/client-go/metadata/metadatalister"
