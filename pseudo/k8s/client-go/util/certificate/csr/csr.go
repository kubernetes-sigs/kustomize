...
import (
	...
	certificates "sigs.k8s.io/kustomize/pseudo/k8s/api/certificates/v1beta1"
	...
	"sigs.k8s.io/kustomize/pseudo/k8s/apimachinery/pkg/fields"
	...
	certificatesclient "sigs.k8s.io/kustomize/pseudo/k8s/client-go/kubernetes/typed/certificates/v1beta1"
	"sigs.k8s.io/kustomize/pseudo/k8s/client-go/tools/cache"
	watchtools "sigs.k8s.io/kustomize/pseudo/k8s/client-go/tools/watch"
	certutil "sigs.k8s.io/kustomize/pseudo/k8s/client-go/util/cert"
)
