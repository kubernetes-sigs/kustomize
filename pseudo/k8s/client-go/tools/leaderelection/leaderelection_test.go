...
import (
	...
	"sigs.k8s.io/kustomize/pseudo/k8s/apimachinery/pkg/api/equality"
	...
	"sigs.k8s.io/kustomize/pseudo/k8s/client-go/kubernetes/fake"
	fakeclient "sigs.k8s.io/kustomize/pseudo/k8s/client-go/testing"
	rl "sigs.k8s.io/kustomize/pseudo/k8s/client-go/tools/leaderelection/resourcelock"
	"sigs.k8s.io/kustomize/pseudo/k8s/client-go/tools/record"
)
