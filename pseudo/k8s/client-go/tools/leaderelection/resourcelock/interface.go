...
import (
	...
	coordinationv1 "sigs.k8s.io/kustomize/pseudo/k8s/client-go/kubernetes/typed/coordination/v1"
	corev1 "sigs.k8s.io/kustomize/pseudo/k8s/client-go/kubernetes/typed/core/v1"
)
