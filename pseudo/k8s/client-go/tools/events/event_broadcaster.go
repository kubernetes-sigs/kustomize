...
import (
	...
	restclient "sigs.k8s.io/kustomize/pseudo/k8s/client-go/rest"

	"sigs.k8s.io/kustomize/pseudo/k8s/api/events/v1beta1"
	...
	typedv1beta1 "sigs.k8s.io/kustomize/pseudo/k8s/client-go/kubernetes/typed/events/v1beta1"
	"sigs.k8s.io/kustomize/pseudo/k8s/client-go/tools/record/util"
	"k8s.io/klog"
)
