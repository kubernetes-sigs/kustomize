...
import (
	...
	runtimejson "sigs.k8s.io/kustomize/pseudo/k8s/apimachinery/pkg/runtime/serializer/json"
	"sigs.k8s.io/kustomize/pseudo/k8s/apimachinery/pkg/runtime/serializer/streaming"
	"sigs.k8s.io/kustomize/pseudo/k8s/apimachinery/pkg/util/wait"
...
// getDecoder mimics how sigs.k8s.io/kustomize/pseudo/k8s/client-go/rest.createSerializers creates a decoder
