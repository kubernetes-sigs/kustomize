...
import (
	...
	v1 "sigs.k8s.io/kustomize/pseudo/k8s/api/admissionregistration/v1"
	v1beta1 "sigs.k8s.io/kustomize/pseudo/k8s/api/admissionregistration/v1beta1"
	...
	v1alpha1 "sigs.k8s.io/kustomize/pseudo/k8s/api/auditregistration/v1alpha1"
	autoscalingv1 "sigs.k8s.io/kustomize/pseudo/k8s/api/autoscaling/v1"
	v2beta1 "sigs.k8s.io/kustomize/pseudo/k8s/api/autoscaling/v2beta1"
	v2beta2 "sigs.k8s.io/kustomize/pseudo/k8s/api/autoscaling/v2beta2"
	batchv1 "sigs.k8s.io/kustomize/pseudo/k8s/api/batch/v1"
	batchv1beta1 "sigs.k8s.io/kustomize/pseudo/k8s/api/batch/v1beta1"
	v2alpha1 "sigs.k8s.io/kustomize/pseudo/k8s/api/batch/v2alpha1"
