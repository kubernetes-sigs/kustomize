...
import (
	...
	clientset "sigs.k8s.io/kustomize/pseudo/k8s/client-go/kubernetes"
	"sigs.k8s.io/kustomize/pseudo/k8s/client-go/rest"
	"sigs.k8s.io/kustomize/pseudo/k8s/client-go/tools/clientcmd"
	"sigs.k8s.io/kustomize/pseudo/k8s/client-go/tools/leaderelection"
	"sigs.k8s.io/kustomize/pseudo/k8s/client-go/tools/leaderelection/resourcelock"
