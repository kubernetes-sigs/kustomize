...
import (
	...
	"sigs.k8s.io/kustomize/pseudo/k8s/client-go/dynamic"
	"sigs.k8s.io/kustomize/pseudo/k8s/client-go/tools/clientcmd"
	"sigs.k8s.io/kustomize/pseudo/k8s/client-go/util/homedir"
	"sigs.k8s.io/kustomize/pseudo/k8s/client-go/util/retry"
	//
	// Uncomment to load all auth plugins
	// _ "sigs.k8s.io/kustomize/pseudo/k8s/client-go/plugin/pkg/client/auth
	//
	// Or uncomment to load specific auth plugins
	// _ "sigs.k8s.io/kustomize/pseudo/k8s/client-go/plugin/pkg/client/auth/azure"
	// _ "sigs.k8s.io/kustomize/pseudo/k8s/client-go/plugin/pkg/client/auth/gcp"
	// _ "sigs.k8s.io/kustomize/pseudo/k8s/client-go/plugin/pkg/client/auth/oidc"
	// _ "sigs.k8s.io/kustomize/pseudo/k8s/client-go/plugin/pkg/client/auth/openstack"
)
