...
// source: k8s.io/kubernetes/vendor/sigs.k8s.io/kustomize/pseudo/k8s/api/admission/v1beta1/generated.proto
...
import (
	...
	k8s_io_apimachinery_pkg_types "sigs.k8s.io/kustomize/pseudo/k8s/apimachinery/pkg/types"
)
...
func init() {
	proto.RegisterFile("k8s.io/kubernetes/vendor/sigs.k8s.io/kustomize/pseudo/k8s/api/admission/v1beta1/generated.proto", fileDescriptor_b87c2352de86eab9)
}
