...
// source: k8s.io/kubernetes/vendor/sigs.k8s.io/kustomize/pseudo/k8s/api/admission/v1/generated.proto
...
func init() {
	proto.RegisterFile("k8s.io/kubernetes/vendor/sigs.k8s.io/kustomize/pseudo/k8s/api/admission/v1/generated.proto", fileDescriptor_4b73421fd5edef9f)
}
