...
// source: k8s.io/kubernetes/vendor/sigs.k8s.io/kustomize/pseudo/k8s/api/imagepolicy/v1alpha1/generated.proto
...
func init() {
	proto.RegisterFile("k8s.io/kubernetes/vendor/sigs.k8s.io/kustomize/pseudo/k8s/api/imagepolicy/v1alpha1/generated.proto", fileDescriptor_834793af728657a5)
}
