...
import (
	...
	"sigs.k8s.io/kustomize/pseudo/k8s/apimachinery/third_party/forked/golang/netutil"
)
...
// Dial implements sigs.k8s.io/kustomize/pseudo/k8s/apimachinery/pkg/util/net.Dialer.
