...
import (
	...
	"sigs.k8s.io/kustomize/pseudo/k8s/apimachinery/pkg/apis/testapigroup"
	"sigs.k8s.io/kustomize/pseudo/k8s/apimachinery/pkg/apis/testapigroup/v1"
...
// overrideMetaFuncs override some generic fuzzer funcs from sigs.k8s.io/kustomize/pseudo/k8s/apimachinery in order to have more realistic
