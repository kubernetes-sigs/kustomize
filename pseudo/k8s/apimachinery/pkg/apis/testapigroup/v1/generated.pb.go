...
// source: k8s.io/kubernetes/vendor/sigs.k8s.io/kustomize/pseudo/k8s/apimachinery/pkg/apis/testapigroup/v1/generated.proto
...
func init() {
	proto.RegisterFile("k8s.io/kubernetes/vendor/sigs.k8s.io/kustomize/pseudo/k8s/apimachinery/pkg/apis/testapigroup/v1/generated.proto", fileDescriptor_b7eb07c7d80facdf)
}
