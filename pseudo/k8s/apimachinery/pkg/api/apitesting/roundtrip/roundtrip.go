...
import (
	...
	apitesting "sigs.k8s.io/kustomize/pseudo/k8s/apimachinery/pkg/api/apitesting"
	...
	apimeta "sigs.k8s.io/kustomize/pseudo/k8s/apimachinery/pkg/api/meta"
	metafuzzer "sigs.k8s.io/kustomize/pseudo/k8s/apimachinery/pkg/apis/meta/fuzzer"
	...
	runtimeserializer "sigs.k8s.io/kustomize/pseudo/k8s/apimachinery/pkg/runtime/serializer"
	"sigs.k8s.io/kustomize/pseudo/k8s/apimachinery/pkg/runtime/serializer/json"
	"sigs.k8s.io/kustomize/pseudo/k8s/apimachinery/pkg/runtime/serializer/protobuf"
