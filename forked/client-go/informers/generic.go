...
import (
	...
	v1beta1 "sigs.k8s.io/kustomize/forked/api/admissionregistration/v1beta1"
	...
	v1alpha1 "sigs.k8s.io/kustomize/forked/api/auditregistration/v1alpha1"
	autoscalingv1 "sigs.k8s.io/kustomize/forked/api/autoscaling/v1"
	v2beta1 "sigs.k8s.io/kustomize/forked/api/autoscaling/v2beta1"
	v2beta2 "sigs.k8s.io/kustomize/forked/api/autoscaling/v2beta2"
