...
import (
	v1 "sigs.k8s.io/kustomize/forked/client-go/informers/autoscaling/v1"
	v2beta1 "sigs.k8s.io/kustomize/forked/client-go/informers/autoscaling/v2beta1"
	v2beta2 "sigs.k8s.io/kustomize/forked/client-go/informers/autoscaling/v2beta2"
