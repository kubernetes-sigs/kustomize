...
import (
	...
	admissionregistration "sigs.k8s.io/kustomize/forked/client-go/informers/admissionregistration"
	apps "sigs.k8s.io/kustomize/forked/client-go/informers/apps"
	auditregistration "sigs.k8s.io/kustomize/forked/client-go/informers/auditregistration"
	autoscaling "sigs.k8s.io/kustomize/forked/client-go/informers/autoscaling"
	batch "sigs.k8s.io/kustomize/forked/client-go/informers/batch"
	certificates "sigs.k8s.io/kustomize/forked/client-go/informers/certificates"
	coordination "sigs.k8s.io/kustomize/forked/client-go/informers/coordination"
	core "sigs.k8s.io/kustomize/forked/client-go/informers/core"
	discovery "sigs.k8s.io/kustomize/forked/client-go/informers/discovery"
	events "sigs.k8s.io/kustomize/forked/client-go/informers/events"
	extensions "sigs.k8s.io/kustomize/forked/client-go/informers/extensions"
	flowcontrol "sigs.k8s.io/kustomize/forked/client-go/informers/flowcontrol"
	internalinterfaces "sigs.k8s.io/kustomize/forked/client-go/informers/internalinterfaces"
	networking "sigs.k8s.io/kustomize/forked/client-go/informers/networking"
	node "sigs.k8s.io/kustomize/forked/client-go/informers/node"
	policy "sigs.k8s.io/kustomize/forked/client-go/informers/policy"
	rbac "sigs.k8s.io/kustomize/forked/client-go/informers/rbac"
	scheduling "sigs.k8s.io/kustomize/forked/client-go/informers/scheduling"
	settings "sigs.k8s.io/kustomize/forked/client-go/informers/settings"
	storage "sigs.k8s.io/kustomize/forked/client-go/informers/storage"
