...
import (
	...
	"sigs.k8s.io/kustomize/forked/client-go/kubernetes/fake"
	fakeclient "sigs.k8s.io/kustomize/forked/client-go/testing"
	rl "sigs.k8s.io/kustomize/forked/client-go/tools/leaderelection/resourcelock"
	"sigs.k8s.io/kustomize/forked/client-go/tools/record"
)
