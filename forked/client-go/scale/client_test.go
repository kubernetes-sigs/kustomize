...
import (
	...
	fakedisco "sigs.k8s.io/kustomize/forked/client-go/discovery/fake"
	"sigs.k8s.io/kustomize/forked/client-go/dynamic"
	fakerest "sigs.k8s.io/kustomize/forked/client-go/rest/fake"
	...
	extv1beta1 "sigs.k8s.io/kustomize/forked/api/extensions/v1beta1"
	"sigs.k8s.io/kustomize/forked/client-go/restmapper"
	coretesting "sigs.k8s.io/kustomize/forked/client-go/testing"
)
