...
import (
	...
	scaleappsint "sigs.k8s.io/kustomize/forked/client-go/scale/scheme/appsint"
	scaleappsv1beta1 "sigs.k8s.io/kustomize/forked/client-go/scale/scheme/appsv1beta1"
	scaleappsv1beta2 "sigs.k8s.io/kustomize/forked/client-go/scale/scheme/appsv1beta2"
	scaleautoscaling "sigs.k8s.io/kustomize/forked/client-go/scale/scheme/autoscalingv1"
	scaleextint "sigs.k8s.io/kustomize/forked/client-go/scale/scheme/extensionsint"
	scaleext "sigs.k8s.io/kustomize/forked/client-go/scale/scheme/extensionsv1beta1"
)
