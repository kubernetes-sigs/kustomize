...
// source: k8s.io/kubernetes/vendor/sigs.k8s.io/kustomize/forked/apimachinery/pkg/runtime/schema/generated.proto
...
func init() {
	proto.RegisterFile("k8s.io/kubernetes/vendor/sigs.k8s.io/kustomize/forked/apimachinery/pkg/runtime/schema/generated.proto", fileDescriptor_0462724132518e0d)
}
