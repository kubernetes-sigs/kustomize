...
// source: k8s.io/kubernetes/vendor/sigs.k8s.io/kustomize/forked/apimachinery/pkg/apis/meta/v1/generated.proto
...
import (
	...
	k8s_io_apimachinery_pkg_types "sigs.k8s.io/kustomize/forked/apimachinery/pkg/types"
)
...
func init() {
	proto.RegisterFile("k8s.io/kubernetes/vendor/sigs.k8s.io/kustomize/forked/apimachinery/pkg/apis/meta/v1/generated.proto", fileDescriptor_cf52fa777ced5367)
}
