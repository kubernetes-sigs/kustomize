...
// source: k8s.io/kubernetes/vendor/sigs.k8s.io/kustomize/forked/api/node/v1alpha1/generated.proto
...
import (
	...
	k8s_io_api_core_v1 "sigs.k8s.io/kustomize/forked/api/core/v1"
	v11 "sigs.k8s.io/kustomize/forked/api/core/v1"
	k8s_io_apimachinery_pkg_api_resource "sigs.k8s.io/kustomize/forked/apimachinery/pkg/api/resource"
	resource "sigs.k8s.io/kustomize/forked/apimachinery/pkg/api/resource"
...
func init() {
	proto.RegisterFile("k8s.io/kubernetes/vendor/sigs.k8s.io/kustomize/forked/api/node/v1alpha1/generated.proto", fileDescriptor_82a78945ab308218)
}
