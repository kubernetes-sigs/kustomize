...
// source: k8s.io/kubernetes/vendor/sigs.k8s.io/kustomize/forked/api/scheduling/v1beta1/generated.proto
...
func init() {
	proto.RegisterFile("k8s.io/kubernetes/vendor/sigs.k8s.io/kustomize/forked/api/scheduling/v1beta1/generated.proto", fileDescriptor_6cd406dede2d3f42)
}
