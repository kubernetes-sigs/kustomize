...
import (
	...
	admissionv1 "sigs.k8s.io/kustomize/forked/api/admission/v1"
	admissionv1beta1 "sigs.k8s.io/kustomize/forked/api/admission/v1beta1"
	admissionregv1 "sigs.k8s.io/kustomize/forked/api/admissionregistration/v1"
	admissionregv1beta1 "sigs.k8s.io/kustomize/forked/api/admissionregistration/v1beta1"
	appsv1 "sigs.k8s.io/kustomize/forked/api/apps/v1"
	appsv1beta1 "sigs.k8s.io/kustomize/forked/api/apps/v1beta1"
	appsv1beta2 "sigs.k8s.io/kustomize/forked/api/apps/v1beta2"
	authenticationv1 "sigs.k8s.io/kustomize/forked/api/authentication/v1"
	authenticationv1beta1 "sigs.k8s.io/kustomize/forked/api/authentication/v1beta1"
	authorizationv1 "sigs.k8s.io/kustomize/forked/api/authorization/v1"
	authorizationv1beta1 "sigs.k8s.io/kustomize/forked/api/authorization/v1beta1"
	...
	autoscalingv2beta2 "sigs.k8s.io/kustomize/forked/api/autoscaling/v2beta2"
	batchv1 "sigs.k8s.io/kustomize/forked/api/batch/v1"
	batchv1beta1 "sigs.k8s.io/kustomize/forked/api/batch/v1beta1"
	batchv2alpha1 "sigs.k8s.io/kustomize/forked/api/batch/v2alpha1"
	certificatesv1beta1 "sigs.k8s.io/kustomize/forked/api/certificates/v1beta1"
	coordinationv1 "sigs.k8s.io/kustomize/forked/api/coordination/v1"
	coordinationv1beta1 "sigs.k8s.io/kustomize/forked/api/coordination/v1beta1"
	...
	imagepolicyv1alpha1 "sigs.k8s.io/kustomize/forked/api/imagepolicy/v1alpha1"
	networkingv1 "sigs.k8s.io/kustomize/forked/api/networking/v1"
	networkingv1beta1 "sigs.k8s.io/kustomize/forked/api/networking/v1beta1"
	nodev1alpha1 "sigs.k8s.io/kustomize/forked/api/node/v1alpha1"
	nodev1beta1 "sigs.k8s.io/kustomize/forked/api/node/v1beta1"
	policyv1beta1 "sigs.k8s.io/kustomize/forked/api/policy/v1beta1"
	rbacv1 "sigs.k8s.io/kustomize/forked/api/rbac/v1"
	rbacv1alpha1 "sigs.k8s.io/kustomize/forked/api/rbac/v1alpha1"
	rbacv1beta1 "sigs.k8s.io/kustomize/forked/api/rbac/v1beta1"
	schedulingv1 "sigs.k8s.io/kustomize/forked/api/scheduling/v1"
	schedulingv1alpha1 "sigs.k8s.io/kustomize/forked/api/scheduling/v1alpha1"
	schedulingv1beta1 "sigs.k8s.io/kustomize/forked/api/scheduling/v1beta1"
	settingsv1alpha1 "sigs.k8s.io/kustomize/forked/api/settings/v1alpha1"
	storagev1 "sigs.k8s.io/kustomize/forked/api/storage/v1"
	storagev1alpha1 "sigs.k8s.io/kustomize/forked/api/storage/v1alpha1"
	storagev1beta1 "sigs.k8s.io/kustomize/forked/api/storage/v1beta1"

	"github.com/stretchr/testify/require"
	"sigs.k8s.io/kustomize/forked/apimachinery/pkg/api/apitesting/fuzzer"
