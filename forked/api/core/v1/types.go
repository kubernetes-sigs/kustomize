...
const (
	// KustomizeFork is used to verify the correct version of this library is being used
	APIKustomizeFork = metav1.ApiMachineryKustomizeFork
...
// +genclient
// +genclient:method=GetScale,verb=get,subresource=scale,result=sigs.k8s.io/kustomize/forked/api/autoscaling/v1.Scale
// +genclient:method=UpdateScale,verb=update,subresource=scale,input=sigs.k8s.io/kustomize/forked/api/autoscaling/v1.Scale,result=sigs.k8s.io/kustomize/forked/api/autoscaling/v1.Scale
// +k8s:deepcopy-gen:interfaces=sigs.k8s.io/kustomize/forked/apimachinery/pkg/runtime.Object
...
type Preconditions struct {
	...
	// +optional
	UID *types.UID `json:"uid,omitempty" protobuf:"bytes,1,opt,name=uid,casttype=sigs.k8s.io/kustomize/forked/apimachinery/pkg/types.UID"`
}
...
type ObjectReference struct {
	...
	// +optional
	UID types.UID `json:"uid,omitempty" protobuf:"bytes,4,opt,name=uid,casttype=sigs.k8s.io/kustomize/forked/apimachinery/pkg/types.UID"`
