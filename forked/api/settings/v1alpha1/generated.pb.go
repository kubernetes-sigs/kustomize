...
// source: k8s.io/kubernetes/vendor/sigs.k8s.io/kustomize/forked/api/settings/v1alpha1/generated.proto
...
func init() {
	proto.RegisterFile("k8s.io/kubernetes/vendor/sigs.k8s.io/kustomize/forked/api/settings/v1alpha1/generated.proto", fileDescriptor_48fab0a6ea4b79ce)
}
