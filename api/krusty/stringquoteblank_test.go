    ...
    spec:
      ...
      - name: mariadb
        ...
        - name: LONG_STRING_BLANK
          value: Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas suscipit ex non molestie varius. Integer pellentesque, est id rhoncus condimentum, est eros tristique diam, ac cursus arcu ante id mi.
