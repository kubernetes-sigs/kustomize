...
func _() {
	...
	_ = x[KustomizeInflator-16]
}

const _BuiltinPluginType_name = ""

var _BuiltinPluginType_index = [...]uint16{0, 7, 29, 47, 62, 81, 97, 119, 139, 163, 193, 209, 232, 255, 270, 289, 316, 333}
