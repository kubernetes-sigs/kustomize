...
func _() {
	...
	_ = x[ResourceGenerator-18]
}

const _BuiltinPluginType_name = ""

var _BuiltinPluginType_index = [...]uint16{0, 7, 29, 47, 65, 80, 99, 115, 137, 157, 181, 211, 227, 250, 273, 288, 307, 334, 356, 373}
