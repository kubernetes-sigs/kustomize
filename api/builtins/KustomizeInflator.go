// Code generated by pluginator on KustomizeInflator; DO NOT EDIT.
...
type KustomizeInflatorPlugin struct {
	KustomizationPaths []string `yaml:"kustomizationPaths"`
	// h contains plugin helpers
	h *resmap.PluginHelpers
}

func (ki *KustomizeInflatorPlugin) Config(h *resmap.PluginHelpers, config []byte) error {
...
func (ki *KustomizeInflatorPlugin) Generate() (resmap.ResMap, error) {
...
func NewKustomizeInflatorPlugin() resmap.GeneratorPlugin {
	return &KustomizeInflatorPlugin{}
}
